...
<main>
    <div class="w-1058 min-h-189 border-solid border rounded-[3px] border-[#ECECEC]">
        ...
        <div class="static w-1028 h-114" >
            <p class="pl-[15px] pr-[15px] pt-[10px] pb-[10px] static font-normal text-[14px] leading-7 text-[#5C5C5C] flex-none order-0 self-stretch tracking-wide">
